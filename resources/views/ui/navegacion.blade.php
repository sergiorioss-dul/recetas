...
<a href="{{route('perfiles.edit',['perfil' => Auth::user()->id])}}" class="btn btn-outline-success text-uppercase font-weight-bold mr-2">
...
<a href="{{route('perfiles.show',['perfil' => Auth::user()->id])}}" class="btn btn-outline-info text-uppercase font-weight-bold mr-2">
